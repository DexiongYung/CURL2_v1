...
class ReplayBuffer(Dataset):
    ...
    def sample_cpc(self):
        ...
        obses, translate_idxs = random_translate(
            obses, self.image_size, return_random_idxs=True
        )
        ...
        _, unique_idxs = self.unique(actions, dim=0)
        unique_idxs = unique_idxs.to(self.device)

        cpc_kwargs = dict(
            obs_anchor=obses[unique_idxs],
            obs_pos=pos[unique_idxs],
            time_anchor=None,
            time_pos=None,
        )
