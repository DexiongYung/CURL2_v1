...
from latent_augs import latent_aug_to_func
...
class LatentRadSacAgent(object):
    """Latent RAD with SAC."""
    def __init__(
        self,
        obs_shape,
        ...
        for aug_str in split_latent_augs:
            assert aug_str in latent_aug_to_func
            self.latent_augs_funcs[aug_str] = latent_aug_to_func[aug_str]
        ...
        self.universal_encoder_optimizer = torch.optim.Adam(self.universal_encoder.parameters())
    ...
    def update(self, replay_buffer, L, step):
        ...
        self.universal_encoder_optimizer.step()
